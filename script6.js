...
// 0, 1
// add numberOne and numberTwo, get numberThree
// add numberTwo and numberThree, get numberFour
// add numberThree and numberFour, get numberFive
// for loop - start with 20 loops
// new variable to hold result - array?
let fibonacciArray = []
let numberOne = 0;
let numberTwo = 1;
let numberThree;
...
console.log(fibonacciArray)//0, 1, 1, 2, 3, 5, 8, etc